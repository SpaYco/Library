...
$jscomp.arrayIterator = function (e) {
  let r = 0;
  return $jscomp.iteratorPrototype(() => (r < e.length ? {
    done: !1,
    value: e[r++],
  } : {
    done: !0,
...
$jscomp.polyfill = function (e, r, p, m) {
  if (r) {
    ...
    m = p[e];
    r = r(m);
    r != m && r != null && $jscomp.defineProperty(p, e, {
      configurable: !0,
      writable: !0,
      value: r,
    });
...
(function (r) {
  ...
  function aa(a, c) {
    ...
    if (h.arr(a)) {
      const b = a.length;
      b !== 2 || h.obj(a[0]) ? h.fnc(c.duration) || (d.duration = c.duration / b) : a = {
        value: a,
      };
    }
    return m(a).map((a, b) => {
  ...
  function R(a, c, d, b) {
    const f = a === 'delay';
    return c.length ? (f ? Math.min : Math.max).apply(Math, c.map((b) => b[a])) : f ? b.delay : d.offset + b.delay + b.duration;
  }
  ...
  function fa(a) {
    ...
    let k;
    for (k in a) {
      e.hasOwnProperty(k) || k === 'targets' || f.push({
        name: k,
        offset: e.offset,
        tweens: aa(a[k], d),
      });
  ...
  function q(a) {
    ...
    function k(a) {
      ...
      if (q > n && q < k) b(q);
      else if (q <= n && r !== 0 && (b(0), x && e()), q >= k && r !== k || !k) b(k), x || e();
      f('update');
    ...
    g.pause = function () {
      const a = v.indexOf(g); a > -1 && v.splice(a, 1);
      g.paused = !0;
    };
    g.play = function () {
